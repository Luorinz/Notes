...
services:
  fnos:
    ...
    volumes:
      - /home/anda/docker/fnOS/fnos_Mainland-PE_x86_1.1.3107_1809.iso:/storage/boot.iso    
      # 将宿主机目录映射到 fnOS 虚拟机内部作为数据盘，请替换 /dir1 和 /dir2 为实际路径
      - /home/anda/docker/fnOS/storage:/storage # 映射到 fnOS 内部的第一个数据盘目录
      - /docker/fnOS/storage2:/storage2 # 映射到 fnOS 内部的第二个数据盘目录
